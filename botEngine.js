...
async function listenToMessages(client) {
  client.on('message', async (message) => {
    ...
    if (message.channel.id === '627445384297316352') { // creations-showcase
      ...
      creationsMessage = await message.channel.send('Reminder: This channel is for posting links to your creations only. You can discuss the projects posted here in the sibling channel <#634025871614803968>. React to a project you\'ve reviewed with :white_check_mark:. Try to review projects that haven\'t been reviewed yet!');
      return;
    }
