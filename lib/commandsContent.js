...
For even more context around on how to hone your question-asking skills, give this a read: https://www.theodinproject.com/guides/community/how_to_ask
    ...
    top: {
        ...
        description: "For more information about The Odin Project, visit our site:\n[Your Career in Web Development Starts Here](https://www.theodinproject.com/)",
    },
    wsl: {
        color,
        title: "WSL",
        description: "For help with using WSL please use the WSL channel: <#1179839248803844117>"
    },
    xy: {
        color,
        title: "This could very well be an xy problem",
        description: "What problem are you *really* trying to solve? Check out [this article about xy problems](https://xyproblem.info/) to help others better understand your question."
    }
