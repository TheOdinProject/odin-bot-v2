...
const QUOTES = [
  ...
  (path) => `Diamonds are a girl's best friend, but ${path.name} can be yours! ${path.emoji}`,
  (path) => `It's time to wake up in the mornings with a ${path.name}! ☕ `,
  (path) => `Ah! Another Odinite. I know just what to do with you... ${path.name} 
...
Will always find their kind.`,
  (path) => `You take the ${path.name} path — you stay in Wonderland, and I show you how deep the rabbit hole goes. Remember: all I'm offering is the truth. Nothing more`,
